...
<body>
<a href="insertFlight">点击添加航班数据</a>
<table border="1" align="center" style="border-collapse: collapse;width: 80%">
    ...
    <tr align="center">
        ...
        <td align="center"><a href="/mayikt_fight_sys_war_exploded/updateFlight?id=${f.id}">修改</a>
            &nbsp;&nbsp;&nbsp;&nbsp;<a href="/mayikt_fight_sys_war_exploded/deleteFlight?id=${f.id}">删除</a></td>
    </tr>
    </c:forEach>
</table>
</body>
